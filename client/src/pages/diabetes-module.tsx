            ...
            <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
              ...
              <DialogContent className="sm:max-w-[425px] border border-[--blue-light] shadow-lg w-[95vw] max-w-[95vw] sm:w-auto sm:max-w-[425px] p-4 sm:p-6">
                <DialogHeader className="mb-2 sm:mb-4">
                  ...
                  <DialogDescription className="sr-only">Formulario para agregar una nueva medición de glucosa</DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-3 sm:space-y-4 py-1 sm:py-2">
                  ...
                  {/* Selector de horario */}
                  <div className="space-y-2">
                    <Label htmlFor="measurement-time" className="font-medium text-sm sm:text-base">Horario de medición</Label>
                    <RadioGroup 
                      id="measurement-time" 
                    ...
                    >
                      <div className={`flex items-center space-x-1 sm:space-x-2 bg-blue-50 px-2 sm:px-4 py-1.5 sm:py-2 rounded-full ${measurementTime === 'en_ayunas' ? 'border border-[--blue-main] bg-blue-100' : 'border border-transparent'}`}>
                      ...
                      <div className={`flex items-center space-x-1 sm:space-x-2 bg-gray-100 px-2 sm:px-4 py-1.5 sm:py-2 rounded-full ${measurementTime === 'despues_comer' ? 'border border-[--blue-main] bg-blue-100' : 'border border-transparent'}`}>
                        <Label
                      ...
                      <div className={`flex items-center space-x-1 sm:space-x-2 bg-gray-100 px-2 sm:px-4 py-1.5 sm:py-2 rounded-full ${measurementTime === '2-3_horas' ? 'border border-[--blue-main] bg-blue-100' : 'border border-transparent'}`}>
                        <Label
                          htmlFor="2-3_horas"
                          className="text-xs sm:text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 cursor-pointer"
                        >
                      ...
                      <div className={`flex items-center space-x-1 sm:space-x-2 bg-gray-100 px-2 sm:px-4 py-1.5 sm:py-2 rounded-full ${measurementTime === 'antes_dormir' ? 'border border-[--blue-main] bg-blue-100' : 'border border-transparent'}`}>
                        <Label
                      ...
                      <div className={`flex items-center space-x-1 sm:space-x-2 bg-gray-100 px-2 sm:px-4 py-1.5 sm:py-2 rounded-full ${measurementTime === 'otro' ? 'border border-[--blue-main] bg-blue-100' : 'border border-transparent'}`}>
                        <Label
                          htmlFor="otro"
                          className="text-xs sm:text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 cursor-pointer"
                        >
                  ...
                  <div className="flex items-center space-x-2 p-2 sm:p-3 border border-gray-200 rounded-md bg-white">
                    <Checkbox 
                      id="use-current-date" 
